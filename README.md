...
Google Maps Extractor helps you find Business Profiles and Reviews from Google Maps. It's a great tool with [2400+ stars on GitHub](https://github.com/omkarcloud/google-maps-scraper/stargazers), trusted by thousands in the community to complete their academic research projects or find customers.
...
1. Enter the **category** (e.g., "restaurants") and select the **country, state, and city** from where you want to extract data.
2. Open the **"Reviews Extraction"** section.
3. Toggle **"Enable Reviews Extraction"** on.
4. Set **"Max Reviews per Place"** (or leave empty to extract all reviews).
5. Choose your sort order: **Newest**, **Most Relevant**, **Highest Rating**, or **Lowest Rating**.
6. Optionally, enter keywords in **"Search in Reviews"** to scrape only reviews containing those words.
7. Press **Run**.

### ❓ How to Filter and Download Reviews?

1. Click **"View Task"** under the "All Tasks" section or within an individual result.
2. Go to the **"Detailed Reviews"** tab.
3. Click **"Show Filters"** at the top to reveal the filtering options.
4. Apply your desired filters, then click the **Export** button below the page to download the filtered data as CSV, JSON, or Excel.

### ❓ How to Scrape Reviews in Different Languages?

Set your preferred language in the **"Language and Max Results"** field before running the scrape. The tool captures the `original_language` of each review and provides a `review_translated_text` in your chosen language.
